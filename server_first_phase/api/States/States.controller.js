...
function addingstates(req, res, doc, callback){
  req.body.State = doc[1];
  req.body.StateCode = doc[0];
  req.body.Country = "598c3cbe8c49af9023216437";
...
exports.index = function(req, res) {
  States.find({},{StateCode: 0, Country: 0}).lean().sort({State: 1}).exec(function (err, Statess) {
    if(err) { return handleError(res, err); }
...
exports.show = function(req, res) {
  States.find({Country: req.params.id},{State: 1}, function (err, States) {
    if(err) { return handleError(res, err); }
