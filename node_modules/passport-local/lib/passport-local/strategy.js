...
Strategy.prototype.authenticate = function(req, options) {
  ...
  var name = req.body.UserName;//this is for login with username
  ...
  try{
    if (self._passReqToCallback) {
      this._verify(req, username, password, name, verified);
    } else {
      this._verify(username, password, name, verified);
    }
  } catch (ex) {
